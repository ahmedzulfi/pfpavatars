...
export default function Pricing() {
  ...
  return (
      <PageTransitionWrapper>
        <main className="min-h-screen sm:pt-10 bg-[#fafafa] text-background w-full font-[family-name:var(--font-geist-sans)]">
          <section className="max-w-[90%] w-full md:w-[1250px] mx-auto px-4 pt-16 md:pt-24 pb-16">
            <div className="text-center mb-12">
              ...
              <p className="text-sm sm:text-base md:text-lg text-gray-700 max-w-2xl mx-auto mb-8">
