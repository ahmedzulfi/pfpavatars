...
export default function GetStarted() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      localStorage.setItem("uploaded_avatar", uploadedImage.name);
      router.push("/result");
    } catch (error) {
                              ...
                              <div className="p-4 sm:p-6 md:p-8">
                                ...
                                <div className="mt-6 sm:mt-8 p-3 sm:p-4 bg-blue-50 rounded-lg">
                                  <p className="text-xs sm:text-sm text-blue-800 flex items-start sm:items-center">
                                    ...
                                    <span>
                                      Your avatars will be generated in about
                                      2-3 minutes. You'll receive 20+ unique
                                      avatars in high resolution.
                                    </span>
                                  </p>
                                </div>
                              </div>
