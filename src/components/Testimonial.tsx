    ...
    <section className="py-16 md:py-24 bg-white relative overflow-hidden">
      <div className="container mx-auto max-w-[90%] w-full md:w-[1250px] px-4 sm:px-6 lg:px-2 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <span className="inline-flex px-4 py-1.5 mb-4 text-sm font-medium rounded-full bg-[#ffedc9] text-yellow-950">
            <Sparkles className="h-4 w-4 me-2 text-yellow-700" /> Loved by
            Creators
          </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-white border border-gray-100 rounded-xl shadow-xs p-6 relative"
            >
              <div className="flex items-center space-x-1 mb-4">
                {[...Array(testimonial.rating)].map((b, i) => (
                  <Star
                    key={i}
              ...
              <div className="flex items-center mt-4">
                ...
                />
                <div className="ml-3">
                  <h4 className="font-medium text-dark-950">
                    {testimonial.name}
                  </h4>
              ...
              <div className="absolute top-0 right-0 -mt-2 -mr-2 bg-[#ffedc9] rounded-full p-1.5">
                <svg
                ...
                >
                  <path
                    d="M7.5 12H5C3.89543 12 3 11.1046 3 10V6C3 4.89543 3.89543 4 5 4H9C10.1046 4 11 4.89543 11 6V10C11 13.866 7.86599 17 4 17V15C6.76142 15 9 12.7614 9 10M21 12H18.5C17.3954 12 16.5 11.1046 16.5 10V6C16.5 4.89543 17.3954 4 18.5 4H22.5C23.6046 4 24.5 4.89543 24.5 6V10C24.5 13.866 21.366 17 17.5 17V15C20.2614 15 22.5 12.7614 22.5 10"
                    fill="currentColor"
                  />
                </svg>
              </div>
